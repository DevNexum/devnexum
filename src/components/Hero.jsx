const Hero = () => {
  return (
    <section className="flex flex-col items-center justify-center min-h-screen px-6 overflow-hidden text-center text-white bg-gradient-to-r from-black to-blue-900">
      ...
      <p className="max-w-3xl text-lg font-light md:text-2xl lg:text-3xl">
      ...
      <button className="px-6 py-3 mt-6 text-lg font-medium text-white transition duration-300 bg-blue-500 rounded-lg hover:bg-blue-600 sm:text-xl lg:text-2xl">
        Get Started
      </button>
    </section>
  );
